...
public interface EventParticipationRepository extends JpaRepository<EventParticipation, Long> {
        ...
        @Query("SELECT p.event FROM EventParticipation p WHERE p.volunteer = :volunteer ORDER BY p.event.startAt ASC")
        org.springframework.data.domain.Page<DisasterEvent> findEventsByVolunteer(
